    ...
    <section className="relative w-full py-0 border-t border-gray-200 bg-white">
      ...
      <div className="absolute top-8 left-6 md:left-24 z-20 pointer-events-none mix-blend-difference text-white">
        <div className="flex items-center gap-3">
          ...
          <span className="font-sans text-[10px] font-bold uppercase tracking-widest">Vista Panorámica en Vivo</span>
        </div>
        <h2 className="font-serif text-3xl mt-2">San Miguel De Tucumán</h2>
      </div>
      ...
      <div className="absolute top-8 right-6 md:right-24 z-20 pointer-events-none mix-blend-difference text-white text-right hidden md:block">
        <span className="font-sans text-[10px] font-bold uppercase tracking-widest block mb-1">Elevación</span>
        <span className="font-serif text-xl">450 m</span>
      </div>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 border-t border-white/10 bg-black/20 backdrop-blur-md flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            <span>330°</span>
            <span>|</span>
            <span className="text-white font-bold text-sm flex items-center gap-2"><Compass size={14} /> NORTE</span>
            <span>|</span>
            <span>30°</span>
            <span>|</span>
            <span>NE</span>
